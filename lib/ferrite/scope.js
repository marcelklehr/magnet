...
Scope.prototype.backtrace = function() {
  var trace = [];
  if(this.precursor) {
    trace.push({caller: this.precursor.meta.identifier, at: this.meta.calledFrom});
...
Scope.prototype.execute = function execute( node ) {
  ...
  switch( node.type )
  {
    ...
    case NODE_OP:
      switch( node.value )
      {
        ...
        case OP_PUTS:
          ...
          }catch(e){ throw MagnetError(e.message, node.children[0].offset, this);}
          return addr;
      ...
      /* Comparison Operators */
        case OP_EQU:
          ...
          }catch(e){ throw MagnetError(e.message, node.offset, this); }
    ...
    case NODE_CALL:
      ...
      if(func instanceof Nil) throw MagnetError('Trying to call a non-existent function.', node.offset, this);
