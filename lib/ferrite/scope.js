...
Scope.prototype.execute = function execute( node ) {
  ...
  switch( node.type )
  {
    ...
    case NODE_BOOL:
      return TypeFactory.makeBoolean(this.env, node.value);
    
    case NODE_INT:
      return TypeFactory.makeInteger(this.env, node.value);
    
    case NODE_FLOAT:
      return TypeFactory.makeFloat(this.env, node.value);
    
    case NODE_STR:
      return TypeFactory.makeString(this.env, node.value);
    
    
    case NODE_OBJ:
      var props = (node.value) ? this.execute(node.value) : [];
      var obj = this.env.resolve(TypeFactory.makeObject(this.env));
    ...
    case NODE_LIST:
      ...
      return TypeFactory.makeList(this.env, list);
    ...
    case NODE_FUNC:
      ...
      return TypeFactory.makeFunction(this.env, this, this.execute(node.value), params);// env, inheritScope, code, params
