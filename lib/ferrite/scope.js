...
Scope.prototype.execute = function execute( node ) {
  ...
  switch( node.type )
  {
    ...
    case NODE_OBJ:
      ...
      var obj = TypeFactory.makeObject(this.env);
      props.forEach(function(p) {
        obj.setPropertyPointer(p.property, p.pointer);
      });
      return this.env.set(obj);
    ...
    case NODE_LIST:
      ...
      return this.env.set(TypeFactory.makeList(this.env, list));
    ...
    case NODE_FUNC:
      ...
      var func = TypeFactory.makeFunction(this.env, this, this.execute(node.value), params);// env, inheritScope, code, params
