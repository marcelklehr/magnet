...
Scope.prototype.setPropertyPointer = function setPointer(identifier, addr) {
  ...
  if(this.parent && !this.properties[identifier] && this.parent.properties[identifier]) return this.parent.setPropertyPointer(identifier, addr);
...
Scope.prototype.execute = function execute( node ) {
  ...
  switch( node.type )
  {
    ...
    case NODE_CALL:
      ...
      // invoke function
      var ret = this.env.cast('function', func).invoke(thisvar, args);
      if(ret != 0) {
