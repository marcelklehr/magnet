...
module.exports.interpret = function interpret(code, lib) {
  ...
  try {
    ...
    if(!(e instanceof MagnetError)) throw e;
    return {errors: [{ msg: 'Runtime Error: '+e.message, line: calcLineNo(code, e.offset), col: getLineCol(code, e.offset), excerpt: getLineExcerpt(code, e.offset) }]};
  };
