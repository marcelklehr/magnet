...
*/
  ...
  // push
  object.properties['count'] = env.set( TypeFactory.makeNativeFunction(env, function(precScope /* , obj...*/) {
    var length = 0; for(var prop in this.properties) if(isInt(prop)) length++;
    var args = Array.prototype.slice.call(arguments);;
    args.shift();
    
    args.forEach(function(obj) {
      this.setPropertyPointer(length, env.set(obj));
    });
    return env.set(this);
  }));
